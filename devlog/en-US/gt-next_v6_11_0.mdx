...
**gt-next@6.11.0** adds `$maxChars` parameter support to translation functions, building on the [`formatCutoff()`](/docs/platform/core/reference/utility-functions/formatting/format-cutoff) functionality introduced in [`generaltranslation@8.1.0`](/devlog/generaltranslation_v8_1_0).
