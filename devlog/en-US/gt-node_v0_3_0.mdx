...
`gt-node` now exports locale utility functions: [`getLocale()`](/docs/node/reference/functions/get-locale), [`getDefaultLocale()`](/docs/node/reference/functions/get-default-locale), [`getLocales()`](/docs/node/reference/functions/get-locales), and [`getLocaleProperties()`](/docs/node/reference/functions/get-locale-properties).
...
Returns the default locale set in [`initializeGT`](/docs/node/reference/functions/initialize-gt).
