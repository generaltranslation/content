...
- It overrides any custom [`getLocale`](/docs/react/nextjs/reference/functions/get-locale) functions (locale resolution reads the URL path)
- It disables [`getRegion`](/docs/react/nextjs/reference/functions/get-region) and `getDomain` functions
...
Following the introduction of static rendering support in gt-next@6.9, we are now deprecating the legacy static request functions (`getStaticLocale`, `getStaticRegion`, `getStaticDomain`) in favor of the standard request functions ([`getLocale`](/docs/react/nextjs/reference/functions/get-locale), [`getRegion`](/docs/react/nextjs/reference/functions/get-region), `getDomain`).
...
Remove any custom `getStaticLocale`, `getStaticRegion`, or `getStaticDomain` functions in favor of custom [`getLocale`](/docs/react/nextjs/reference/functions/get-locale), [`getRegion`](/docs/react/nextjs/reference/functions/get-region), or `getDomain` functions. You must add a custom [`getLocale`](/docs/react/nextjs/reference/functions/get-locale) function and disable the [`getRegion`](/docs/react/nextjs/reference/functions/get-region) function. For more information, see the [SSG guide](/docs/react/nextjs/app-router-static-site-generation).
