...
date: 2026-03-16
authors: [ernest]
tags: ['gt-react', 'gt-i18n', 'v10.12.0', 't', 'string-translation', 'browser', 'synchronous', 'i18n', 'vite']
---
...
You need to change the entry point of your app to run `bootstrap()` first. In a default Vite app, that would typically be `main.tsx`, but you can configure the entry point in your `index.html`.
...
<Callout>
**Vite only:** This feature currently requires Vite as your build tool.
</Callout>
