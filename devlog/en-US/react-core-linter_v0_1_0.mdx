...
- [`static-jsx`](/docs/react/reference/lint-rules#static-jsx) - Enforces proper variable wrapping in [`<T>`](/docs/react/reference/components/t) components
...
The `static-jsx` rule prevents dynamic content from appearing directly inside [`<T>`](/docs/react/reference/components/t) components.
Dynamic content must be wrapped in [variable components](/docs/react/guides/formatting-variables).
