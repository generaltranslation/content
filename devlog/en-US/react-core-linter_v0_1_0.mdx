...
- [`static-jsx`](/docs/react/reference/lint-rules#static-jsx) - Enforces proper variable wrapping in `<T>` components
- [`static-string`](/docs/react/reference/lint-rules#static-string) - Ensures static strings in translation functions
...
Dynamic content must be wrapped in [variable components](/docs/react/guides/format-variables).
...
- [Variable Components](/docs/react/guides/format-variables) - Handle dynamic content in translations
- [String Translation](/docs/react/guides/translate-strings) - Translate plain text strings
