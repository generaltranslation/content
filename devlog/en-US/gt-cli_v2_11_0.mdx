...
The GT CLI can now publish **any translated file type** to the GT CDN. JSON, MDX, YAML, and all other [supported file types](/docs/cli/reference/formats/gt-jsx-files) can now be published directly from the `translate`, `upload`, and `save-local` commands.
