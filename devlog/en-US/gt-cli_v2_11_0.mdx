...
The GT CLI can now publish **any translated file type** to the GT CDN. JSON, MDX, YAML, and all other [supported file types](/docs/cli/reference/formats/gt-jsx-files) can now be published directly from the [`translate`](/docs/cli/reference/commands/translate), [`upload`](/docs/cli/reference/commands/upload), and [`save-local`](/docs/cli/reference/commands/save-local) commands.
...
| Command | Behavior |
|---------|----------|
| [`gt translate`](/docs/cli/reference/commands/translate) | Publishes after downloading translations |
| [`gt upload`](/docs/cli/reference/commands/upload) | Publishes after uploading source files |
| [`gt save-local`](/docs/cli/reference/commands/save-local) | Publishes after saving local edits |
