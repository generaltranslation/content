...
**This behavior is currently deprecated, see [gt-next@6.10.0](/devlog/gt-next_v6_10_0) for the new behavior.**
...
Beyond static generation, this release also introduces support for custom [`getLocale()`](/docs/react/nextjs/reference/functions/get-locale) and [`getRegion()`](/docs/react/nextjs/reference/functions/get-region) functions that can be configured for both SSR and static rendering environments.
