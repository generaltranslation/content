...
Now, it can support arbitrary JSX expressions resolvable at build time such as nexted jsx text, ternary operators, conditional statements, and function calls.
