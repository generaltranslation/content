...
Dev hot reload requires the GT compiler plugin in your configuration. Add the compiler to your bundler config (e.g., the Vite or Webpack plugin), then enable dev hot reload.
