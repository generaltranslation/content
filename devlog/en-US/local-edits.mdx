...
_Version note: This post describes the 2.4.0 behavior. In `gt` and `gtx-cli` 2.16.0, pass `--save-local` to [`translate`](/docs/cli/reference/commands/translate) to run the save step._
