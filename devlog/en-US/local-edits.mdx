...
_Version note: This post describes the 2.4.0 behavior. In `gt` and `gtx-cli` 2.16.0, pass `--save-local` to `translate` to run the save step; see the current [`gt translate` reference](/docs/cli/reference/commands/translate)._
