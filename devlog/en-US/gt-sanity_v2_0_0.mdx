...
The plugin no longer registers a Translations tab view automatically. The Translate dialog replaces this as the default interaction model. If you still want a dedicated tab, you can add it manually — see the [quickstart](/docs/integrations/sanity/quickstart).
