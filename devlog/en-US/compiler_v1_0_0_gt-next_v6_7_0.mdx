---
title: '@generaltranslation/compiler@1.0.0 / gt-next@6.7.0'
headline: Build-time optimizations for every React app
date: 2025-10-10
authors: [ernest]
tags: ['@generaltranslation/compiler', 'v1.0.0', 'compiler', 'translation', 'i18n']
---

## Overview

We are very excited to announce the release of `@generaltranslation/compiler` v1.0.0.
