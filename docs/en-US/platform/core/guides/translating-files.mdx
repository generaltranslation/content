...
description: How to translate files with the generaltranslation library: this guide covers uploading a source file, enqueuing translation, checking status, and downloading the translated file

related:
  links:
    - /docs/platform/core/reference/gt-class-methods/translation/upload-source-files
    - /docs/platform/core/reference/gt-class-methods/translation/query-file-data
    - /docs/platform/core/reference/gt-class/constructor
    - /docs/platform/core/reference/gt-class-methods/translation/enqueue-files
---
...
import { FileUpload } from 'generaltranslation/types';
