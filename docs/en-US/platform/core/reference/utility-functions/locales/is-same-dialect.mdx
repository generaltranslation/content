...
`isSameDialect` is a standalone utility function from General Translation's Core library that checks whether multiple BCP-47 locale codes represent the same dialect.
