...
`getRegionProperties` is a standalone utility function from General Translation's Core library that returns metadata about a region code, including its localized name and a representative emoji.
