...
| [`customMapping`](#custom-mapping) | Custom mapping for locale codes and names. | `CustomMapping` | Yes | — |
...
The localized display name of the locale. Returns the locale code itself if no display name can be determined.
