...
Call `determineLocale` on a `GT` instance with one or more preferred locales, in preference order. It returns the best matching approved locale, or `undefined` when none matches.
