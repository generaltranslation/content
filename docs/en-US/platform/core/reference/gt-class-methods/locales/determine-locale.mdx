...
*Note: the source docs previously showed `['fr-CA', 'es-MX', 'en-US']` resolving to `'es-ES'`; because higher-preference language matches win over lower-preference exact matches, the first preference `fr-CA` resolves to `fr-FR`.*
