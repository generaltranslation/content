...
- **File encoding.** Text content is automatically base64-encoded. Binary `LOTTIE` and `DOT_STRINGS` translations must already be base64-encoded.
...
| `fileFormat` | Format of the file. See [`FileFormat`](/docs/platform/core/reference/types/file-format) for the complete list. | [`FileFormat`](/docs/platform/core/reference/types/file-format) | No |
...
| Field | Description | Type | Optional |
| --- | --- | --- | --- |
| `content` | Raw translated text, or base64-encoded binary content for `LOTTIE` and `DOT_STRINGS`. | `string` | No |
