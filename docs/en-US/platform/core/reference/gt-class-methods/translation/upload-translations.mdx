...
| `fileFormat` | Format of the file. See the complete [`FileFormat`](/docs/platform/core/reference/types/file-format) union. | [`FileFormat`](/docs/platform/core/reference/types/file-format) | No |
