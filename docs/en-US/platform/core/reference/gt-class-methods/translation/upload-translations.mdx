...
| --- | --- | --- | --- | --- |
| [`files`](#files) | Array of source file references with their translations. | `TranslationUpload[]` | No | — |
| [`options`](#options) | Configuration options for the upload. | `UploadFilesOptions` | No | — |

### `files` [#files]

**Type** `TranslationUpload[]` · **Required**

Each `TranslationUpload` pairs a source file reference with its translated files:
