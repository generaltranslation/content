...
For translation jobs returned by `enqueueFiles`, use [`awaitJobs`](/docs/platform/core/reference/gt-class-methods/translation/await-jobs) instead of manual polling. Poll setup job IDs with `checkJobStatus`.
