...
| --- | --- | --- | --- |
| `content` | Raw text content, including SVG XML, or base64-encoded binary content for `LOTTIE`. | `string` | No |
...
- Supported file formats are `GTJSON`, `JSON`, `PO`, `POT`, `YAML`, `MDX`, `MD`, `TS`, `JS`, `HTML`, `TXT`, `TWILIO_CONTENT_JSON`, `LOTTIE`, and `SVG` — see [`FileFormat`](/docs/platform/core/reference/types/file-format) for the complete list.
