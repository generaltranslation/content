...
| `fileFormat` | File format. See [`FileFormat`](/docs/platform/core/reference/types/file-format) for the complete list. | [`FileFormat`](/docs/platform/core/reference/types/file-format) | Yes |
