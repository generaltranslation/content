...
*Note: every method on this page calls the General Translation API and requires an API key on the `GT` instance. Locale codes in arguments are normalized to their canonical form before the request.*
