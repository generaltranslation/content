...
*Note: every method on this page calls the General Translation API and requires a project ID and an API key on the [`GT`](/docs/platform/core/reference/gt-class/constructor) instance. Locale codes in arguments are normalized to their canonical form before the request.*
