...
Call `formatCutoff` on a `GT` instance with the string to truncate and an options object specifying `maxChars`. It returns the truncated string with the terminator applied.
