...
The installed 0.3.2 SDK provides generated helpers for these public operations:

| Function | Operation |
| --- | --- |
| [`listOrgs`](/docs/platform/openapi/reference/project/list-orgs) | List Organizations where the signed-in user can create projects. |
| [`listProjects`](/docs/platform/openapi/reference/project/list-projects) | List projects the request identity can read. |
| [`createProject`](/docs/platform/openapi/reference/project/create-project) | Create a project in a selected Organization. |
| [`createProjectApiKey`](/docs/platform/openapi/reference/project/create-api-key) | Create a project API key with all delegable permissions or a narrower permission list. |
