...
Most framework apps should start with [gt-react or gt-next](/docs/react/get-started/overview). Use `generaltranslation` directly when you want lower-level control, a custom workflow, or translation utilities outside a framework integration.
