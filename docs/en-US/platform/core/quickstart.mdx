...
Create a `GT_PROJECT_ID` and `GT_API_KEY` in the Dashboard. Open the [API Keys page](https://dash.generaltranslation.com/api-keys), select **Create Key**, enter a name, choose its permissions, and confirm.
