...
Upgrading removes your rate limit and also unlocks features including Locadex workflows, team invites, auto-reload, the Translation Editor, annotations, version branching, Project integrations, shared Context Groups, and unlimited Projects.
