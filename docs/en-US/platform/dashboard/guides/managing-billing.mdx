...
Current programs include [Mercury](https://generaltranslation.com/enterprise/contact/mercury) and [a16z speedrun](https://generaltranslation.com/enterprise/contact/speedrun). The application dialog shows the grant amount and expiration period for the recognized code.
