...
Review consumption under **Organization > Usage**. Select **Tokens**, **Agent**, or **Cost** if you can view billing. The page opens to the current billing period when one is available, or the last 30 days otherwise. You can also select the last 7 days or a custom date range of up to 100 days.
...
- **Ask AI** is charged in **Locadex Compute Units (LCUs)**.
