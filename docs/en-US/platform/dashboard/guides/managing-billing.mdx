...
- **Lottie** adds a per-transition **Layout Processing** charge to its translation workflow.
...
Upgrading removes your rate limit and also unlocks Locadex workflows, team invites, auto-reload, annotations, version branching, Project integrations, and unlimited Projects.
