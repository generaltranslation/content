...
Current programs include [Mercury](https://generaltranslation.com/enterprise/contact/mercury) and a16z. The a16z offer is available to eligible [a16z startups](https://generaltranslation.com/enterprise/contact/a16z) and [a16z speedrun startups](https://generaltranslation.com/enterprise/contact/speedrun). The application dialog shows the grant amount and expiration period for the recognized code.
