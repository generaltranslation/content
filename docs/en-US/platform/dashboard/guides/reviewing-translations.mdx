...
description: "How to review and edit translations in the General Translation Dashboard: this guide covers manual edits, comparing locales, and inspecting version history."
related:
  links:
...
Use the Dashboard editor when you need to inspect generated translations, compare target locales, or make a precise correction without running a new translation job.
