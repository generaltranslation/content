...
For supported raw formats, toggle **Raw** to edit the underlying file content in a code editor. Use **Search in file** to find or replace text within the open file. SVG edits must remain well-formed XML.
