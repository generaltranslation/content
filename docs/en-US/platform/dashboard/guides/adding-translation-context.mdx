...
related:
  links:
    - /docs/cli/quickstart
    - /docs/platform/locadex/get-started
---
...
For full retranslation of a file instead, use the [CLI](/docs/cli/quickstart) or run [Locadex](/docs/platform/locadex/get-started) translation.