...
description: How to use Context Groups, Glossary, and Directives to guide AI translations.
related:
  links:
...
Context Groups apply reusable translation instructions across Projects.
