...
description: How to use Context Groups with Glossary (key terms) and Directives (tone and style) to guide AI translation in the General Translation Dashboard.
related:
  links:
...
*Note that Context Groups apply to new translations but do not automatically rewrite existing translations. See [Apply Glossary translations](#apply-glossary).*
...
*Editing a Context Group will apply to all new translations but does not automatically update existing translations.*
