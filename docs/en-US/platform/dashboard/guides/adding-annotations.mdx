...
description: How to coordinate translation reviews by entry and locale with labels, notes, and comments.
related:
  links:
...
<Callout type="info">
  Annotations require a Starter, Team, or Enterprise plan. Adding or changing annotations also requires **Review & approve translations** permission (`translations:review:write`).
</Callout>

## Annotation scope and types [#annotation-scope-types]
...
The Dashboard supports three annotation **types**: labels, notes, and comments.
...
On **Project > Translations**, click the **Tag** icon to quickly add a label for the selected entry.
...
<Walkthrough
  src="https://assets.gtx.dev/walkthroughs/dashboard/adding-annotations.json"
  title="Adding annotations"
/>


## Manage and filter labels [#manage-filter-labels]
