...
1. Open your Organization and go to **Webhooks > Endpoints**.
...
You can manually retry a delivery from **Webhooks > Events**. Select an event in **Recent events**, hover over a row in **Delivery attempts**, and click **Retry**.
...
From **Webhooks > Endpoints**, you can:
