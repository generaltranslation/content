...
You can manually retry a failed delivery from **Organization > Developer > Webhook Events** in the Dashboard. Select an event in **Recent events**, hover over a row in **Delivery attempts**, and click **Retry**.
...
2. Select an event in **Recent events**.
