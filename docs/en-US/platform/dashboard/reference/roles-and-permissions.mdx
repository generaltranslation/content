...
The Organization-level **Locadex > Automations** and **Locadex > Integrations** pages use the **Read GitHub integration** permission. Creating, editing, running, or deleting a Project automation also requires **Write Locadex automations and settings** for that Project.
