...
The Organization-level **Locadex > Automations** and **Locadex > Integrations** pages use the **Read GitHub integration** permission. Starting, continuing, stopping, or reviewing a [Locadex chat session](/docs/platform/locadex/reference/chat) requires **Manage Locadex secrets**, as does adding, editing, or deleting Organization-level Locadex secrets. Creating, editing, running, or deleting a project automation requires **Write Locadex automations and settings** for that project.
