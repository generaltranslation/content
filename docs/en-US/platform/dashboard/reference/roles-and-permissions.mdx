...
SSO requires the same Organization or Enterprise manage permission and an Enterprise plan. See [Configuring SSO](/docs/platform/dashboard/guides/configuring-sso).
