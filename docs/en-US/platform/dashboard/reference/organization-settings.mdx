...
See Locadex usage from the **Locadex** tab. Manage your plan, billing, and credit balance from **Organization > Billing**. [Contact us](https://generaltranslation.com/en-US/enterprise/contact) if you're interested in Enterprise plans for larger teams with complex localization needs.
