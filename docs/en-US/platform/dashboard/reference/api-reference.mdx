...
Use the [`@generaltranslation/api` TypeScript SDK](/docs/platform/openapi/reference/typescript-sdk) for generated request and response types, or browse the [OpenAPI reference](/docs/platform/openapi/overview) to call endpoints directly.
