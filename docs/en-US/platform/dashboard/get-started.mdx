...
- **Organization** contains **Projects**, Platform Context, **Connections** for authorized external services, **Usage**, **Plans**, and **Locadex > Automations** and **Locadex > Integrations**. **Developer** contains **API Keys**, **Webhooks**, and **Webhook Events**. **Settings** contains **General**, **Members**, **Access**, **SSO / SCIM**, **Partnerships**, **Billing**, and **Audit Logs**.
...
<Walkthrough
  src="https://assets.gtx.dev/walkthroughs/dashboard/get-started.json"
