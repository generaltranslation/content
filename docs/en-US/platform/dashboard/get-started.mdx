...
- **Organization** contains Projects, team members, shared context, API keys, webhooks, usage, and Connections for authorized external services.
- **Project** contains translations, Project context, API keys, settings, Locadex configuration, and **Integrations > Connected** and **Integrations > Catalog**.
