...
- **Organization** contains Projects, shared context, usage, Connections for authorized external services, and **Locadex > Automations** and **Locadex > Integrations**. **Developer** contains **API Keys**, **Webhooks**, and **Webhook Events**. **Settings** contains **General**, **Members**, **Access**, **SSO**, **Billing**, **Plans**, and **Audit Logs**.
