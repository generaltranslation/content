...
Locadex is the AI i18n agent that manages your entire internationalization workflow — from wrapping content in translation components, to syncing translation edits back to your GitHub repository. It can run manually or automatically when it detects changes.
