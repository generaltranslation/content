...
- **Default:** 200 requests/minute for project and project API-key creation, project and Organization discovery, branches, tags, project info, job info, file info, translation status, and runtime translation.
