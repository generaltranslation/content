...
The hosted OpenAPI schema lists `XCSTRINGS` as a file format, but source and translated-file uploads reject `.xcstrings` content. The public API and CLI do not currently accept Xcode String Catalogs.
