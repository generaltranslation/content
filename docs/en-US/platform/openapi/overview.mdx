...
- **Default:** 200 requests/minute for project discovery, project and project API-key creation, branches, tags, project info, job info, file info, translation status, and runtime translation.

Project discovery and project/key creation share a request limit. Authentication attempts may also be rate-limited.
