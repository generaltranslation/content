...
- [Files](/docs/platform/openapi/reference/files/upload-source): Uploading, downloading, moving, publishing, and inspecting files.
- [Context](/docs/platform/openapi/reference/context/generate-context): Generating translation context and checking context job status.
- [Translation](/docs/platform/openapi/reference/translation/translate-runtime): Queuing files, translating content at runtime, and retrieving job status.
- [Project](/docs/platform/openapi/reference/project/project-info): Reading and updating Project information, and managing branches and tags.
