...
Choose the source locale and target languages, then start setup. Locadex prepares the repository and opens a pull request. Merge that pull request before running the automation.
