...
- **Auto-merge** — asks GitHub to squash-merge immediately after Locadex publishes its changes; off by default; blocking rules and repair changes leave the pull request open for review
