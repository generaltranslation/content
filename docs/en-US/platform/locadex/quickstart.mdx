...
Before you start, you need a [General Translation](https://dash.generaltranslation.com) Project and a GitHub repository containing a project built with one of Locadex's supported frameworks.
