...
related:
  links:
    - /docs/platform/locadex/guides/using-chat
...
Organizations with Locadex chat enabled can also start on-demand sessions across one or more connected GitHub repositories.
