...
- `WORKFLOW_ABORTED` indicates that the run stopped before execution or completion. A billing block uses this code for an exhausted balance, spend limit, failed payment, or ended subscription. Follow the run message and update the applicable Organization or Enterprise settings. (See [Managing billing](/docs/platform/dashboard/guides/managing-billing)).
