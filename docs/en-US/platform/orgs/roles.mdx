...
Every member of an organization is assigned a **role** that determines what they can access and modify. Roles are assigned when a member is invited or can be changed later by an Admin.
