...
You provide these connection settings once in the **Connect** dialog at **Project > Integrations**; General Translation stores them on the Project and uses them to call the Storyblok Management API.
