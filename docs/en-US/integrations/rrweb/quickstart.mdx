...
`gt-rrweb` turns one recorded product walkthrough into a replay you can publish in every locale. Record a flow once, pair its text with your existing translation catalogs, and viewers watch it in their language.
