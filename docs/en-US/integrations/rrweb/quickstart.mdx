...
Mount [`GTRecorder`](/docs/integrations/rrweb/reference/recorder#gt-recorder) once inside your translation provider. Pass the same catalog loader your app uses, then call [`useRecorder()`](/docs/integrations/rrweb/reference/recorder#use-recorder) from any descendant control.
...
Import the saved JSON and render [`GTReplayer`](/docs/integrations/rrweb/reference/replayer#gt-replayer):
