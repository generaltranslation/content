...
| Connect or reconnect a personal Google account | `project:files:write` and `project:translations:enqueue` | Starter or Enterprise |
| Add, remove, or translate files in the Dashboard | `translations:content:write` | Starter or Enterprise |
