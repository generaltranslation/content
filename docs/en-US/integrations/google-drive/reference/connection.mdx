...
| Add, remove, or translate files | `translations:content:write` | Starter or Enterprise |
| Configure an Organization shared drive | `org:manage` | Enterprise |

Without a Starter or Enterprise plan, the catalog shows an upgrade prompt in place of the connection controls. Without the required permission, the corresponding action is unavailable.
