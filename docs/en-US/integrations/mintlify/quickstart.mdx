...
- A General Translation [Project](/docs/platform/dashboard/get-started) on a plan that includes Locadex.
...
*Note: if Locadex is not included in your plan, the Dashboard shows an upgrade prompt instead of setup, so you cannot connect a repository.*
