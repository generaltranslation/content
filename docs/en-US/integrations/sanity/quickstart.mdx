...
With this document-level setup, the plugin polls for completed translations and imports them automatically because auto-refresh and auto-import are on by default. Auto-patch and auto-publish are off by default, so imported documents stay as drafts with their original references until you run **Patch References** and **Publish Translations** from the dialog or turn those toggles on.
