...
See the full guides to [translate content](/docs/integrations/sanity/guides/translate-content) and [manage translations](/docs/integrations/sanity/guides/manage-translations).
...
See [Query translations](/docs/integrations/sanity/guides/query-translations) for more query patterns.
