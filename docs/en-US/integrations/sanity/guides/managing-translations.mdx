...
If `translation.metadata` points to a translated document that was deleted, importing that locale creates a new translated document and replaces the stale metadata entry.
