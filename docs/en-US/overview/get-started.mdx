...
Using Vue 3? Start with the [`gt-vue` Quickstart](/docs/vue/quickstart). The runtime is currently unstable and may change between 0.x releases.
...
**Which library should I use?** Use `gt-react` for React apps, `gt-next` for Next.js, and [`gt-vue`](/docs/vue/quickstart) for Vue 3. Use the [Node](/docs/node/quickstart) or [Python](/docs/python/quickstart) libraries for backend services, and the [Core library](/docs/platform/core/quickstart) for lower-level control in any JavaScript runtime.
