...
description: Use AI coding agents and LLMs with General Translation by pointing them at the machine-readable docs, the MCP server, and a drop-in agent guide.
...
*For fully automated localization that opens pull requests on its own, use our dedicated agent [Locadex](/docs/platform/locadex/get-started) instead of driving your own agent.*
...
In async server components, use `getGT` instead:
...
- [`sitemap.md`](/sitemap.md) — map of every docs page.
- Quickstarts: [React](/docs/react/get-started/react-quickstart), [Node](/docs/node/quickstart), [Core library](/docs/platform/core/quickstart), and the [CLI](/docs/cli/quickstart).
