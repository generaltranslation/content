...
```bash
GT_API_KEY="gtx-api-..."   # Project key with permissions for your CLI workflow
GT_PROJECT_ID="..."
```
...
| Command                          | When to run                                                                                                                                                         |
| -------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `npx gt init`                    | Once, to set up a project (installs dependencies, configures the framework, creates `gt.config.json`, and configures project access when needed).                    |
| `npx gt configure`               | To create or update `gt.config.json` (locales and files) without the full wizard.                                                                                   |
| `npx gt login`                   | To sign in for interactive CLI workflows.                                                                                                                           |
| `npx gt api-key create`          | To create a project key with explicit permissions for CI or another non-interactive workflow.                                                                       |
