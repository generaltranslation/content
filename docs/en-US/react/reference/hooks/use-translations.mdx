...
The `useTranslations` hook accesses string translations from the [translation dictionary](/docs/react/guides/dictionaries) by id. This is the dictionary-based alternative to the [`<T>`](/docs/react/reference/components/t) component and [`useGT`](/docs/react/reference/hooks/use-gt).
...
- See the [dictionaries guide](/docs/react/guides/dictionaries) for setup and conventions.
