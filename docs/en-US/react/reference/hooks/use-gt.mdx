...
- **On-demand in development.** With a project key supplied through the development credential setting, `gt` translates on demand so you can preview locales, with a slight delay that does not occur in production.
