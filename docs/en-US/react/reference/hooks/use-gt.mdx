...
- **On-demand in development.** With `devApiKey` set to a project key that has runtime translation permission, `gt` translates on demand so you can preview locales. This delay does not occur in production.
