...
- **On-demand in development.** With a `devApiKey` configured, `gt` translates on demand so you can preview locales, with a slight delay that does not occur in production.
