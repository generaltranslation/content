...
- **On-demand in development.** With runtime translation enabled on your project key, `gt` translates on demand so you can preview locales, with a slight delay that does not occur in production.
