...
| Version | Changes |
| --- | --- |
| 11.4.4 | Server-rendered providers keep their rendered locale in server props; setters write the locale cookie and request a refresh or reload instead of updating a client snapshot first. |
