...
*Note: in `gt-react` v11, this options object is the exported [`GTTranslationOptions`](/docs/react/reference/config) type. Variables are inserted into the translation but are never translated themselves.*
