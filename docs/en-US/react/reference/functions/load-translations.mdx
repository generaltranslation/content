...
`gt-react` has built-in support for loading translations from local files in your bundle. See [Store translations locally](/docs/react/guides/local-translations).
...
- `loadTranslations` customizes how translations are loaded in production; its most common use is [local translations](/docs/react/guides/local-translations).
