...
<Callout type="info">
  **Note:** [`npx gt translate`](/docs/cli/reference/commands/translate) needs a project ID and a project API key, set as `GT_PROJECT_ID` and `GT_API_KEY` in your environment. Run [`npx gt auth`](/docs/cli/reference/commands/auth) or visit the [Dashboard](/docs/platform/dashboard/get-started) to get them.
</Callout>
