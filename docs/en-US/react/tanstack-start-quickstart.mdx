...
<Callout type="info">
  **Note:** [`npx gt translate`](/docs/cli/reference/commands/translate) needs a project ID and authentication. Run [`npx gt login`](/docs/cli/reference/commands/login) for interactive work. In CI, set `GT_PROJECT_ID` and a project key in `GT_API_KEY`.
</Callout>
