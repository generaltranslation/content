...
*Note: in Expo, public environment variables must be prefixed with `EXPO_PUBLIC_`. Only expose a **Custom** project key with **Runtime translation** enabled in your app bundle.*
