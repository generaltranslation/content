...
For example, this file structure gives `/home` a French-specific page while every other locale uses the shared page:
...
export default createNextMiddleware({
  routeOverrides: {
    fr: [
      '/home', // Static route
      '/products/[id]', // Single dynamic parameter
...
A French request for `/fr/home` renders `app/[locale]/fr/home/page.tsx`. Other locales render `app/[locale]/home/page.tsx`. The dynamic and catch-all patterns work the same way for their matching pages.
