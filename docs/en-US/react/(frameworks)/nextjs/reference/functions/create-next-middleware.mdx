...
The `createNextMiddleware` function from `gt-next/middleware` adds locale-based routing and detection to a Next.js app. It detects each visitor's locale, persists it in a cookie, and routes them to the localized version of a page.

Use the [App Router middleware guide](/docs/react/nextjs/app-router-middleware) or [Pages Router middleware guide](/docs/react/nextjs/pages-router-middleware) for router-specific setup.
