...
- `/product/[id]` uses the French product page while preserving the dynamic `id`.
- `/blog/[[...slug]]` applies the French implementation to `/blog` and every child route, including `/blog/authors`, `/blog/posts`, and `/blog/posts/[...slug]`.
