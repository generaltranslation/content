...
<Callout type="info">
  **Next.js 15.1–15.4:** Import `unstable_rootParams` from `next/server`
  instead, then return `(await unstable_rootParams())?.locale`.
  `next/root-params` is available in Next.js 15.5 and newer.
</Callout>
