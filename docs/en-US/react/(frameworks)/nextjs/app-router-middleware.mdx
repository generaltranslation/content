...
## Read the root locale during static generation [#root-locale]

When middleware does not run during static generation, create `getLocale.ts` at your project root. `withGTConfig` detects this file automatically.
