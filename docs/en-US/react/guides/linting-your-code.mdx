...
- **[`static-jsx`](/docs/react/reference/lint-rules#static-jsx)** — flags unstructured dynamic content inside [`<T>`](/docs/react/reference/components/t) and requires it to be wrapped in a variable component ([`<Var>`](/docs/react/reference/components/var), [`<Num>`](/docs/react/reference/components/num), [`<Currency>`](/docs/react/reference/components/currency), or [`<DateTime>`](/docs/react/reference/components/datetime)). Structured components such as [`<RelativeTime>`](/docs/react/reference/components/relative-time) and [`<Plural>`](/docs/react/reference/components/plural) define their own dynamic inputs and remain valid inside [`<T>`](/docs/react/reference/components/t). Auto-fixable.
