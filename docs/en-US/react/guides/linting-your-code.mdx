...
description: How to catch common internationalization mistakes with the General Translation ESLint plugin across React, Next.js, TanStack Start, and React Native
