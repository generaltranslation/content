...
description: 'Instructions for configuring gt-react in a Vite-powered single-page React application.'
---
...
This is a guide on how to set up `gt-react` in a Vite-powered single-page React application.
...
Create a new file to bootstrap the application. From there, we can import the entry point file. In this example, we create `src/index.ts` as our bootstrap file and import `src/main.tsx` as our entry point file. The first thing we need to do is update the entry point to our boostrap in the html:
