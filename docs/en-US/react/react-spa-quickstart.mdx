...
<Callout type="info">
  **Rollup:** Plain Rollup cannot analyze the fully dynamic import above. Use the [static locale-loader map](/docs/react/guides/previewing-spa-translations#setup) instead.
</Callout>
...
<Callout type="info">
  **Tip:** Follow [Previewing SPA translations](/docs/react/guides/previewing-spa-translations) to add the compiler and development credentials.
</Callout>
