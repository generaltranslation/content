...
*Note: Rollup cannot analyze this fully dynamic import path. Use the [static locale-loader map](/docs/react/concepts/compiler#adapters) shown in the compiler concepts.*
