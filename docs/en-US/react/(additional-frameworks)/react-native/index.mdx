...
If you are just getting started, follow the [React Native Quickstart](/docs/react/react-native-quickstart) first. The shared [Guides](/docs/react/guides) and [Reference](/docs/react/reference) cover everything that works the same across frameworks; the pages here cover the React Native-only setup.
