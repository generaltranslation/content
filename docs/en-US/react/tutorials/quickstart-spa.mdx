...
<Callout type='info'>
  **File location:** Bundlers like Vite import translation files as modules, so they should live inside `src/`. If you load translations over HTTP instead (see the Create React App note in Step 3), use `"public/_gt/[locale].json"`.
</Callout>
