...
- **Local files:** provide a [`loadTranslations`](/docs/react/reference/functions/load-translations) callback that returns translations for a locale. See [Store translations locally](/docs/node/guides/local-translations).
