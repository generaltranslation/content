...
async function loadTranslations(locale) {
  ...
  switch (locale) {
    case 'ja':
      return await import('./translations/ja.json');
    case 'es':
      return await import('./translations/es.json');
    case 'fr':
      return await import('./translations/fr.json');
    default:
      return {};
  }
}
...
Wrap your handler logic inside **`withGT`** so that `getGT` and other translation functions share the same async context:
