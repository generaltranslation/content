...
To see translations in development, you need API keys from General Translation. These enable **runtime translation** — your server translates content in real time as you develop.
...
<Accordions>
  <Accordion title="Can I use gt-node without API keys?">
    Yes. Without API keys, `gt-node` works as a standard i18n library. You won't get runtime translation in development, but you can still:
