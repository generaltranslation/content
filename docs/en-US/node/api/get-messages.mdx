...
```ts
Promise<(encodedMsg: string | null | undefined, options?: GTTranslationOptions) => string | null | undefined>
```
...
| `options?` | `GTTranslationOptions` | Optional variable values to interpolate into the resolved message. |
