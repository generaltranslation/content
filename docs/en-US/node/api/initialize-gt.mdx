...
| Prop | Description |
| ---- | ----------- |
| `defaultLocale` | The default locale for your application. Defaults to `'en'`. |
...
| `apiKey` | Production API key for cloud translation services. |
...
| `cacheExpiryTime` | Time in milliseconds before cached translations expire. Set to `null` to disable expiry. |
