...
| `options?`            | [`InlineTranslationOptions`](/docs/node/api/types/inline-translation-options) | Translation options to customize the behavior of `msg`. |
...
Make sure to follow the [deployment guide here](/docs/node/tutorials/quickdeploy).
