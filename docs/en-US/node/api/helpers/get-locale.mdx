...
- See [`getLocales`](/docs/node/api/helpers/get-locales) for the full list of supported locales.
- See [`getLocaleProperties`](/docs/node/api/helpers/get-locale-properties) for locale metadata.
