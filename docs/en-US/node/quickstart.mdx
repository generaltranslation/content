...
Make your project ID and project API key with runtime translation permission available to the Node.js process:
...
Use a [project API key](/docs/platform/dashboard/reference/api-keys#create-project-keys) with **Runtime translation** enabled. `GT_DEV_API_KEY` is the SDK setting for development hot reload; it accepts a project key starting with `gtx-api-`.
