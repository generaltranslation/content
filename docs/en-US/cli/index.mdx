...
description: Set up and translate your project with the GT command line tool
---
...
<Callout type="info">
  A production API key is required for the `translate` command. The setup wizard can generate one for you, or get one at [generaltranslation.com](https://generaltranslation.com).
</Callout>
...
[GT](/docs/cli/formats/gt) · [JSON](/docs/cli/formats/json) · [MDX](/docs/cli/formats/mdx) · [TypeScript/JavaScript](/docs/cli/formats/ts) · [YAML](/docs/cli/formats/yaml) · [HTML](/docs/cli/formats/html) · [Plain text](/docs/cli/formats/txt)
