...
The General Translation CLI tool (`gtx-cli`) allows you to automatically translate your project into any of the [supported languages](/docs/platform/supported-locales).
...
| [`npx gtx-cli upload`](/docs/cli/upload)       | Uploads source files and translations to the General Translation platform.                    |
| [`npx gtx-cli enqueue`](/docs/cli/enqueue)     | Enqueues files for translation without downloading results.                                   |
| [`npx gtx-cli download`](/docs/cli/download)   | Downloads translations that were previously enqueued or staged.                               |
