...
| [`modelProvider`](#model-provider) | AI model provider used for translation. | `string` | Yes | — |
...
The AI model provider used for file and inline-content translation. Accepted values are `ANTHROPIC`, `OPENAI`, `XAI`, and `GOOGLE`. When omitted, the translation service chooses the provider.
