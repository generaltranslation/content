...
For other file types (`json`, `yaml`, `mdx`, `md`, `pot`, `xliff`, `csv`, `properties`), you can control publishing per-file by using an object in the `include` array instead of a plain glob string:
