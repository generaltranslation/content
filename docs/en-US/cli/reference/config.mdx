...
| --- | --- | --- |
| `gt` | General Translation files for `gt-next`, `gt-react`, `gt-react-native`, and `gt-tanstack-start`. | [GT](/docs/cli/reference/formats/gt-jsx-files) |
...
An array of glob patterns for the source files scanned for inline content when you use `gt-next`, `gt-react`, `gt-react-native`, or `gt-tanstack-start`.
