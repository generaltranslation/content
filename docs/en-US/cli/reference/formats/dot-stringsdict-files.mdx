...
The CLI preserves carriage returns in plist keys and values with XML character references.

| Version | Changes |
| --- | --- |
| `2.20.0` | Decodes byte-order-marked source files before upload and preserves their encoding on download. |
| `2.18.1` | Added the `dotStringsdict` config key. |
