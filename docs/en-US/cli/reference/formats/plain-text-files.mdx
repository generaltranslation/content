...
The CLI translates arbitrary plain text (`txt`) files. The entire file is treated as translatable content, so no markup or structure is preserved or skipped.
