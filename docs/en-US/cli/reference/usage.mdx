...
This guide assumes you have already set up your codebase to use `gt-next` or `gt-react` according to the [gt-next](/docs/next) or [gt-react](/docs/react/tutorials/quickstart) tutorials.
