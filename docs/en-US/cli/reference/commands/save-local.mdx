...
- Never store your API key in `gt.config.json`. Explicit keys take precedence over saved login. (See [credential precedence](/docs/cli/guides/configuring#credentials)).
