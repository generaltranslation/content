...
1. Resolves the project ID and [saved login or explicit tooling key](/docs/cli/guides/configuring#credentials).
...
- The command needs a project ID and authentication authorized to inspect its jobs.
