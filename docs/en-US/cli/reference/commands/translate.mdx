...
2. For `gt-next`, `gt-react`, and `gt-react-native` projects, scans your `src` globs for inline content — `<T>` components and `useGT` calls — and includes your dictionary file.
