...
*Note: Set a project key in `GT_API_KEY` and your `GT_PROJECT_ID` as environment variables. Grant file and translation queue permissions, and never store your API key in `gt.config.json`.*
