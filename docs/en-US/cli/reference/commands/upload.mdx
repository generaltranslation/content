...
7. Applies configured CDN publish and unpublish rules. Pass `--publish` to publish every uploaded translation.
...
| `--publish` | Publish uploaded translations to the CDN. | `boolean` | Yes | `false` |
