...
<Callout type='info'>
  If you are using [`next-intl`](https://next-intl.dev), [`react-i18next`](https://react.i18next.com), or
  [`next-i18next`](https://github.com/i18next/next-i18next), the CLI tool will automatically detect
