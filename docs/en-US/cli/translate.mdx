...
The `gt translate` command translates your project by first reading your `gt.config.json` file to determine which files to translate.
...
<Callout type='info'>
  We recommend running the setup wizard: [`npx gt
