...
*Note: Run [`translate`](/docs/cli/reference/commands/translate) in your CI pipeline before you build for production. It is not meant for development, where the SDKs translate on demand with the key in `GT_DEV_API_KEY` instead.*
