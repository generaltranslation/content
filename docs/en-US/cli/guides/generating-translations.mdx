...
- For interactive work, run [`gt login`](/docs/cli/reference/commands/login). For CI, set a project key in `GT_API_KEY`.
- Set the project ID in `gt.config.json`, `GT_PROJECT_ID`, or `--project-id`.
