...
The [`translate`](/docs/cli/reference/commands/translate) command needs a project API key and project ID. Keep them out of `gt.config.json` and set them as environment variables instead.
