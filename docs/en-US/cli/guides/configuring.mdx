...
Sign in with [`gt login`](/docs/cli/reference/commands/login), then run [`gt init`](/docs/cli/reference/commands/init) to detect your framework, configure files, and optionally provision a project and development runtime key. The wizard can also start login itself when needed.
