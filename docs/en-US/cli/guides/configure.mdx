...
description: Set up a General Translation gt.config.json with your locales, files, and storage options.
...
The `translate` command needs a production API key and Project ID. Keep them out of `gt.config.json` and set them as environment variables instead.
