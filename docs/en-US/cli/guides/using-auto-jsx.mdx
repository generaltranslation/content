...
Add `@generaltranslation/compiler` to your Vite, webpack, Rollup, Rspack, or esbuild configuration. See the [compiler concepts](/docs/react/concepts/compiler#adapters) for adapter examples.
