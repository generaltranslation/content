...
Add `@generaltranslation/compiler` to your Vite, webpack, Rollup, Rspack, or esbuild configuration. See [Previewing SPA translations](/docs/react/guides/previewing-spa-translations#setup) for adapter examples.
