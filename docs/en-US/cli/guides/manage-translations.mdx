...
If your Project uses human review, use [`gt stage`](/docs/cli/reference/commands/stage) instead of translating directly. It works like `translate` but holds the results for approval rather than downloading or publishing them.
