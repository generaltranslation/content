...
See the [React docs](/docs/react/tutorials/quickstart) or the [Next.js docs](/docs/next) for more information.
...
This part of the wizard can also be ran independently via `npx gt setup`.
...
This part of the wizard can also be ran independently via `npx gt configure`.
...
This part of the wizard can also be ran independently via `npx gt auth`.
