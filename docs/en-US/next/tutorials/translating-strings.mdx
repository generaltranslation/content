...
We assume that you already have installed `gt-next` in your project and have followed or are currently following the [Quickstart Guide](/docs/next/tutorials/quickstart).
...
## Next steps
 * Return to the [Quickstart Guide](/docs/next/tutorials/quickstart) to finish setting up your project for translation.
