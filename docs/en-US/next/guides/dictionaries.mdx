...
<Callout type="info">
  **Default locale:** The default-locale dictionary is bundled with your app at build time and loaded synchronously. A custom `loadDictionary` function is only called for non-default locales.
</Callout>
