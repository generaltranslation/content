...
| `options?`            | [`TranslationVariables`](/docs/next/api/types/dictionary-translation-options) | Variables to interpolate into the translated entry. |
...
Place your dictionary in a `dictionary.js`, `dictionary.ts`, or `dictionary.json` file at the root of your project or in the `src/` directory.
See the [dictionaries guide](/docs/next/guides/dictionaries) for more information.
