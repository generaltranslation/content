...
- `GT` extends the `GTRuntime` class from `generaltranslation/runtime`, which accepts the same constructor parameters but omits the project and file-management methods
