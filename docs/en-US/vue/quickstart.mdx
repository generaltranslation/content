...
The command guides you through signing in and creating credentials. Keep the generated project API key in your local environment file and out of browser code and version control.
