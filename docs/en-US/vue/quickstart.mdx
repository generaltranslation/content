...
The command opens a browser or device-code flow and stores the login outside your project. Add your project ID to `gt.config.json`, set `GT_PROJECT_ID`, or pass `--project-id`. Use a project API key instead of an interactive login in CI.
