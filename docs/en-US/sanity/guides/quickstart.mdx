...
<Callout type="info">
  `gt-sanity` v2.0.3+ includes `@sanity/document-internationalization` as a direct dependency. It is installed automatically and does not need to be added separately.
</Callout>
    ...
    export default defineConfig({
      ...
      plugins: [
        gtPlugin({
          ...
          translateDocuments: ['article', 'page'], // Document types to enable translations for
        })
      ]
    })
    ```
