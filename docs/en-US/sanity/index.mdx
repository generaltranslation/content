...
<Callout type="info">
  **No schema changes required.** The plugin works with your existing Sanity schemas as-is.
  Translations are stored as separate documents — you don't need to add i18n fields to your schemas or modify your GROQ queries.
  Just install the plugin, configure it, and start translating.
</Callout>
