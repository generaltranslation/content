---
title: Using declare_static
description: How to use declare_static for word agreement, reusable content, and static analysis
---

## What is `declare_static`?

[`declare_static`](/docs/python/api/declare-static) is an identity function that marks content for the GT CLI's static analysis. When the CLI scans your code, it recognizes `declare_static(...)` calls and determines all possible return values, creating a separate translation entry for each.
