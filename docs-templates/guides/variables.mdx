...
Variable components allow you to safely include dynamic content within [`<T>`](/docs/react/reference/components/t) components. They handle formatting and localization locally without sending data to the translation API, making them perfect for sensitive information like usernames, account numbers, and financial data.

## Available components

- [`<Var>`](/docs/react/reference/components/var): Raw dynamic content without formatting
- [`<Num>`](/docs/react/reference/components/num): Numbers with locale-specific formatting
- [`<Currency>`](/docs/react/reference/components/currency): Currency values with symbols and formatting
- [`<DateTime>`](/docs/react/reference/components/datetime): Dates and times with locale conventions

## Quickstart

Variable components work inside [`<T>`](/docs/react/reference/components/t) to handle dynamic content:

```jsx
import { T, Var, Num, Currency, DateTime } from '__PACKAGE_NAME__';
...
1. **Wrapping dynamic values** so they can be used inside [`<T>`](/docs/react/reference/components/t)
...
Use [`<Var>`](/docs/react/reference/components/var) for any dynamic content that doesn't need special formatting:
...
Use [`<Num>`](/docs/react/reference/components/num) for numbers that should follow locale formatting rules:
...
Use [`<Currency>`](/docs/react/reference/components/currency) for monetary amounts:
...
Use [`<DateTime>`](/docs/react/reference/components/datetime) for dates and times:
...
### Important exception
Be careful with nested [`<T>`](/docs/react/reference/components/t) components inside variable components:
...
Variable components can be used outside of [`<T>`](/docs/react/reference/components/t) for pure formatting:
...
For [`<Currency>`](/docs/react/reference/components/currency), make sure to pass the `currency` prop to specify the currency type. This ensures that the correct currency symbol and formatting are used when displaying the value:
...
- [String Translation Guide](/docs/react/guides/translating-strings) - Translate plain text without JSX
- API References:
  - [`<Var>` Component](/docs/react/reference/components/var)
  - [`<Num>` Component](/docs/react/reference/components/num)
  - [`<Currency>` Component](/docs/react/reference/components/currency)
