...
Dictionaries provide a traditional approach to organizing translations in nested objects with key-value pairs. While [`<T>` components](/docs/react/guides/translating-jsx) are the recommended approach, dictionaries can be useful for migration from other i18n libraries or when you prefer centralized translation storage.

<Callout>
  **Recommendation:** Use [`<T>` components](/docs/react/guides/translating-jsx) for new projects. Dictionaries are supported primarily for migration and compatibility with existing translation workflows.
</Callout>
...
Then you pass it to your [`<GTProvider>`](/docs/react/reference/components/gt-provider) component:
...
The [`useTranslations`](/docs/react/reference/hooks/use-translations) hook lets you access dictionary entries:
...
Most users should use [`loadTranslations`](/docs/react/reference/functions/load-translations) to automatically generate translations from your base dictionary:
...
For migration from other i18n libraries or manual translation management, use [`loadDictionary`](/docs/react/reference/functions/load-dictionary):
...
<Callout>
  **Choose the right approach:** Use [`loadTranslations`](/docs/react/reference/functions/load-translations) for new projects with automatic translation generation, or [`loadDictionary`](/docs/react/reference/functions/load-dictionary) when migrating existing translation files.
</Callout>
...
- **Development**: Dictionary entries translated on-demand with project key with runtime translation permission
- **Production**: All dictionary translations pre-built during build step

## Combining with components

Dictionaries and [`<T>` components](/docs/react/guides/translating-jsx) can work together:
...
- [Languages Guide](/docs/react/guides/managing-locales) - Configure supported languages and locale settings
- [Dynamic Content Guide](/docs/overview/key-concepts#content) - Handle runtime translation needs
- API References:
  - [`useTranslations` Hook](/docs/react/reference/hooks/use-translations)
