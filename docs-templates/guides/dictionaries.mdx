...
Dictionaries provide a traditional approach to organizing translations in nested objects with key-value pairs. While [`<T>` components](/docs/react/guides/translate-jsx) are the recommended approach, dictionaries can be useful for migration from other i18n libraries or when you prefer centralized translation storage.

<Callout>
  **Recommendation:** Use [`<T>` components](/docs/react/guides/translate-jsx) for new projects. Dictionaries are supported primarily for migration and compatibility with existing translation workflows.
</Callout>
...
Dictionaries and [`<T>` components](/docs/react/guides/translate-jsx) can work together:
...
- [Languages Guide](/docs/react/guides/manage-locales) - Configure supported languages and locale settings
