...
<Callout>
  **Tip:** With [auto JSX injection](__DOCS_PATH__/concepts/compiler#auto-jsx-injection) enabled, the compiler can automatically wrap your JSX in translation components at build time.
...
Content in [`<T>`](__DOCS_PATH__/api/components/t) components is sent to the GT API for translation. For sensitive data, use [Variable Components](__DOCS_PATH__/guides/variables) to keep private information local:
