...
<Callout>
  **Tip:** With [auto JSX injection](/docs/cli/guides/auto-jsx) enabled, the compiler can automatically wrap your JSX in translation components at build time.
...
For dynamic content within [`<T>`](/docs/react/reference/components/t), use [Variable Components](/docs/react/guides/format-variables) and [Branching Components](/docs/react/guides/plurals-and-branches).
...
<Callout>
  ...
  See [Variable Components](/docs/react/guides/format-variables) and [Branching Components](/docs/react/guides/plurals-and-branches) guides for details.
</Callout>
...
<Callout>
  Learn more about the [`<Var>` component](/docs/react/reference/components/var) in the [Variable Components Guide](/docs/react/guides/format-variables).
</Callout>
...
Content in [`<T>`](/docs/react/reference/components/t) components is sent to the GT API for translation. For sensitive data, use [Variable Components](/docs/react/guides/format-variables) to keep private information local:
...
<Callout>
  See the [Variable Components Guide](/docs/react/guides/format-variables) for handling dynamic values and the [Branching Components Guide](/docs/react/guides/plurals-and-branches) for conditional content.
</Callout>
...
- [Variable Components Guide](/docs/react/guides/format-variables) - Handle dynamic content within JSX translations
- [Branching Components Guide](/docs/react/guides/plurals-and-branches) - Add conditional logic to your translations
