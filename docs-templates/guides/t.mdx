...
Content in [`<T>`](__DOCS_PATH__/api/components/t) components is sent to the GT API for translation. For sensitive data, use [Variable Components](__DOCS_PATH__/guides/variables#privacy-and-security) to keep private information local:
