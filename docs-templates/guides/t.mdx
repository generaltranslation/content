...
<Callout>
  **Tip:** With [auto JSX injection](/docs/next/concepts/compiler#auto-jsx-injection) enabled, the compiler can automatically wrap your JSX in translation components at build time.
