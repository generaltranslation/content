...
This creates maintenance overhead and makes your code harder to read. The [`msg`](/docs/react/reference/functions/msg) function solves this by letting you mark strings for translation in-place, then decode them when needed.

## Quickstart

Use [`msg`](/docs/react/reference/functions/msg) to mark strings and [`useMessages`](/docs/react/reference/hooks/use-messages) to decode them:
...
1. **Mark Phase**: [`msg`](/docs/react/reference/functions/msg) encodes strings with translation metadata
2. **Decode Phase**: [`useMessages`](/docs/react/reference/hooks/use-messages) decodes and translates the strings
...
<Callout type="warn">
  Encoded strings from [`msg`](/docs/react/reference/functions/msg) cannot be used directly - they must be decoded with [`useMessages`](/docs/react/reference/hooks/use-messages).
</Callout>

## Components

Use [`useMessages`](/docs/react/reference/hooks/use-messages) hook:
...
Sometimes you need to access the original string without translation, such as for logging, debugging, or comparisons. Use [`decodeMsg`](/docs/react/reference/functions/msg) to extract the original text:
...
Never use the output of [`msg`](/docs/react/reference/functions/msg) directly:
...
Every [`msg`](/docs/react/reference/functions/msg) string needs to be decoded:
...
- [Dictionaries Guide](/docs/react/guides/translating-with-dictionaries) - Organize translations with structured data
- [Languages Guide](/docs/react/guides/managing-locales) - Configure supported languages
- API References:
  - [`msg` Function](/docs/react/reference/functions/msg)
