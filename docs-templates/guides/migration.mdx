...
<Tabs items={['npm', 'yarn', 'bun', 'pnpm']}>
  ...
  <Step>
    ...
    ```
    For more detailed steps, see the [project quickstart](/docs/react/react-quickstart) guide.
  </Step>
  <Step>
...
See the [dictionaries](/docs/react/guides/translating-with-dictionaries) guide for more details.
