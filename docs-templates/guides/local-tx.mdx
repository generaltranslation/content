...
By default, `__PACKAGE_NAME__` fetches translations from the General Translation CDN. When translating your app using our API, translations are automatically saved to our CDN.
...
### Step 2: Configure loadTranslations
Register `loadTranslations` with `initializeGT()` at your app's entry point, before rendering:
