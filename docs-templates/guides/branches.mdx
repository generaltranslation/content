...
Branching components enable conditional content rendering within [`<T>`](/docs/react/reference/components/t) components. They handle dynamic logic like if/else statements and pluralization rules while ensuring all content variations can be properly translated.

## Available components

- [`<Branch>`](/docs/react/reference/components/branch): Conditional content based on values or states
- [`<Plural>`](/docs/react/reference/components/plural): Automatic pluralization using locale-specific rules

## Quickstart

Branching components work inside [`<T>`](/docs/react/reference/components/t) to handle conditional logic:

```jsx
import { T, Branch, Plural, Num, Var } from '__PACKAGE_NAME__';
...
1. **Replacing ternary operators** and conditional logic inside [`<T>`](/docs/react/reference/components/t)
...
Use [`<Branch>`](/docs/react/reference/components/branch) for any conditional rendering based on values or states:
...
Use [`<Plural>`](/docs/react/reference/components/plural) for content that changes based on quantity:
...
Convert conditional logic for use within [`<T>`](/docs/react/reference/components/t):
...
Branching components can be used outside [`<T>`](/docs/react/reference/components/t) for pure logic without translation:
...
- [Dynamic Content Guide](/docs/overview/key-concepts#content) - Handle runtime translation
- API References:
  - [`<Branch>` Component](/docs/react/reference/components/branch)
