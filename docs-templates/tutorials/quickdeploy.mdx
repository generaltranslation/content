...
If you haven't, first set up your project by following the [Quick Start Guide](__DOCS_PATH__/tutorials/quickstart).
...
<Callout>
  ...
  You will also need to configure the [`loadTranslations`](__DOCS_PATH__/api/config/load-translations) function.
</Callout>
 ...
 * Read about the difference between production and development environments [here](__DOCS_PATH__/concepts/environments).
