...
If you haven't, first set up your project by following the [Quickstart Guide](/docs/react/get-started/react-quickstart).
...
## Next steps
 * See the [CLI docs](/docs/cli/reference) for more information on the CLI tool.
 * Learn about the different configuration options for the CLI tool [here](/docs/cli/reference/commands/configure).
 * Read about the difference between production and development environments [here](/docs/react/guides/configure).
