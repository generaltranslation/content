...
We'll assume that you have already setup your __FRAMEWORK_NAME__ app with GT.
If you haven't, first setup your project by following the [Quick Start Guide](__DOCS_PATH__/tutorials/quickstart).
