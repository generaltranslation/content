...
## Next steps
 * For more details and usage examples of the `<RelativeTime>` component and other variable components like `<DateTime>`, `<Currency>`, `<Num>`, and `<Var>`, see the [Using Variable Components](/docs/react/guides/formatting-variables) documentation.
