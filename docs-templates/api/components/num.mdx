...
## Next steps
 * For more details and usage examples of the `<Num>` component and other variable components like `<Currency>`, `<DateTime>`, and `<Var>`, see the [Using Variable Components](/docs/react/guides/format-variables) documentation.
