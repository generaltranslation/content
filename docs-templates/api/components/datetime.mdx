...
## Next steps
 * For more details and usage examples of the `<DateTime>` component and other variable components like `<Currency>`, `<Num>`, and `<Var>`, see the [Using Variable Components](__DOCS_PATH__/guides/variables) documentation.
