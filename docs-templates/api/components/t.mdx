...
## Next steps
 * Look into more advanced features like on-demand translation, variables, context, and handling plurals, refer to the [`<T>` Design Patterns](__DOCS_PATH__/guides/jsx) documentation.
