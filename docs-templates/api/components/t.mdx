...
| `context`   | Additional context to refine the translation. Useful for resolving ambiguous phrases. Accepts a string or `derive()` for [context derivation](__DOCS_PATH__/api/components/derive#context-derivation). |
