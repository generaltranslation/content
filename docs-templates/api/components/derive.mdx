...
- For variable content within translations, see the [`<Var>`](/docs/react/reference/components/var) component.
- For the main translation component, see [`<T>`](/docs/react/reference/components/t).
- For the string equivalent of `<Derive>`, see [`derive`](/docs/react/reference/functions/derive).