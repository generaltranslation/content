...
## Next steps
 * For more details and usage examples of the `<Currency>` component and other variable components like `<Num>`, `<DateTime>`, and `<Var>`, see the [Using Variable Components](/docs/react/guides/format-variables) documentation.
