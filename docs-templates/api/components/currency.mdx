...
| Prop      | Description                                                                                                                                            |
|-----------|--------------------------------------------------------------------------------------------------------------------------------------------------------|
| `children`  | The content to render inside the component. Typically a number representing the value to be formatted as currency. Strings will be parsed into numbers before formatting. |
...
import { Currency } from '__PACKAGE_NAME__'; // [!code highlight]
...
```jsx title="PriceDisplay.jsx" copy
import { Currency } from '__PACKAGE_NAME__';
...
```jsx title="PriceDisplay.jsx" copy
import { T, Currency } from '__PACKAGE_NAME__';
...
## Next steps
 * For more details and usage examples of the `<Currency>` component and other variable components like `<Num>`, `<DateTime>`, and `<Var>`, see the [Using Variable Components](/docs/react/guides/formatting-variables) documentation.
