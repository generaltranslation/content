...
## Next steps
 * For a more in depth discussion and usage examples for the `<Var>` component and other variable components like `<Currency>`, `<DateTime>`, and `<Num>`, see the [Using Variable Components](__DOCS_PATH__/guides/variables) documentation.
