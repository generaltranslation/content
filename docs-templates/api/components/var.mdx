...
## Next steps
 * For a more in-depth discussion and usage examples for the `<Var>` component and other variable components like `<Currency>`, `<DateTime>`, and `<Num>`, see the [Using Variable Components](/docs/react/guides/formatting-variables) documentation.
