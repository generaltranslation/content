...
It is used with [`useTranslations`](/docs/react/reference/hooks/use-translations) to pass variables to dictionary entries.
...
In order to pass a variable to the dictionary entry, we need to do two things: (1) add a variable to the entry and (2) reference said variable in the [`d`](/docs/react/reference/hooks/use-translations) invocation.
...
## Next steps
 * See [dictionaries](/docs/react/guides/translating-with-dictionaries) for more information on dictionaries and common practices.
 * See [`useTranslations`](/docs/react/reference/hooks/use-translations) for more information on dictionaries interface.
