...
The encoded string should be passed to the [`useMessages`](__DOCS_PATH__/api/strings/use-messages) hook or `getMessages` function to retrieve translations.
 ...
 * See `getMessages` for translating strings in async server-side components.
