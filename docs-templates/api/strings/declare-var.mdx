...
If you want to remove the ICU markers, you can use [`decodeVars`](/docs/react/reference/functions/decode-vars).
...
|-----------------------|--|-----------------------------------------------------------------------------|
| `value`               | ` string \| number \| boolean \| null \| undefined` | The dynamic value to be marked as a variable.                             |
...
```jsx copy
import { declareVar, derive, useGT } from '__PACKAGE_NAME__';
...
## Next steps
* See [`derive`](/docs/react/reference/functions/derive) for creating static function calls in strings
* See [`decodeVars`](/docs/react/reference/functions/decode-vars) for extracting original values
* See [`<Var>`](/docs/react/reference/components/var) for the JSX equivalent