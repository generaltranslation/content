...
## Next steps
* See [`declareVar`](/docs/react/reference/functions/declare-var) for marking dynamic content within static functions
* See [`decodeVars`](/docs/react/reference/functions/decode-vars) for extracting original values from declared variables
* See [`<Derive>`](/docs/react/reference/components/derive) for the JSX equivalent
