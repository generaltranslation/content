...
## Next steps
* See [`declareVar`](/docs/react/reference/functions/declare-var) for marking dynamic content
* See [`derive`](/docs/react/reference/functions/derive) for creating static function calls
* See [`msg`](/docs/react/reference/functions/msg) for string encoding and decoding patterns