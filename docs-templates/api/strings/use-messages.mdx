...
```jsx
(encodedContent: string, options?: InlineTranslationOptions) => string
```

| Name             | Type                  | Description                                                  |
| ---------------- | --------------------- | ------------------------------------------------------------ |
| `encodedContent` | `string`              | The encoded string content from `msg` to be translated.      |
| `options?`       | [`InlineTranslationOptions`](/docs/react/reference/types/inline-translation-options) | Optional parameters to pass variables to the encoded string. |
...
- See [`msg`](/docs/react/reference/functions/msg) for encoding strings for translation.
