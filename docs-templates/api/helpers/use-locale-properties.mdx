...
| `maximizedName` | `string` | The English name of the maximized locale (e.g., `'Austrian German (Latin)'`). |
| `nativeMaximizedName` | `string` | The maximized locale name in the locale's own language. |
| `minimizedCode` | `string` | The minimized locale code (e.g., `'de-AT'`, or just `'de'`). |
| `minimizedName` | `string` | The English name of the minimized locale. |
| `nativeMinimizedName` | `string` | The minimized locale name in the locale's own language. |
| `emoji` | `string` | The region-based emoji flag for the locale. |
...
- Learn more about [locale codes](/docs/platform/core/guides/locale-codes).
