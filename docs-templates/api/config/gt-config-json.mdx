...
This file is read by (1) your [`<GTProvider>`](__DOCS_PATH__/api/components/gtprovider) component and (2) the [`gtx-cli translate`](/docs/cli/translate) command.
 ...
 * It is read by both the [`<GTProvider>`](__DOCS_PATH__/api/components/gtprovider) component and the [`gtx-cli translate`](/docs/cli/translate) command.
