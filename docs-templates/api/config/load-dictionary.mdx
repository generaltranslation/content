...
<Callout>
  **Question:** What's the difference between [`loadTranslations`](/docs/react/reference/functions/load-translations) and [`loadDictionary`](/docs/react/reference/functions/load-dictionary)?

  * [`loadTranslations`](/docs/react/reference/functions/load-translations) is used to define custom loading behavior for fetching translations for your app.
  ...
  * [`loadDictionary`](/docs/react/reference/functions/load-dictionary) is intended for implementations of `__PACKAGE_NAME__` as a standalone library.
 ...
 * Dictionaries loaded by `loadDictionary` will take precedence over translations loaded by [`loadTranslations`](/docs/react/reference/functions/load-translations).

## Next steps
 * If you want to write your own translations check out [custom translations](/docs/react/guides/storing-translations).
 * See [`loadTranslations`](/docs/react/reference/functions/load-translations) for more information on writing a custom translation loader.
