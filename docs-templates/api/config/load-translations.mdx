...
Follow [this guide](/docs/react/guides/storing-translations) to set up local translations in your __FRAMEWORK_NAME__ app.
...
When configured to use [local translations](/docs/react/guides/storing-translations), the [`gt translate`](/docs/cli/reference/commands/translate) command, translations are saved to the `./src/_gt` directory.
 ...
 * Its most common use case is for adding [local translations](/docs/react/guides/storing-translations)
