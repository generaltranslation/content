...
When configured to use [local translations](__DOCS_PATH__/guides/local-tx), the [`gtx-cli translate`](/docs/cli/translate) command, translations are saved to the `./src/_gt` directory.
