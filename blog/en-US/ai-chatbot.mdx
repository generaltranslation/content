...
Next, I installed the [`gt-next`](https://github.com/General-Translation/gt-libraries) and [`gtx-cli`](https://github.com/General-Translation/gt-libraries) packages.

```bash
npm install gt-next gtx-cli
```
...
```bash
npx gtx-cli translate --locales es fr zh
```
