...
For dynamic content inside `<T>`, see the docs on [variable components](https://generaltranslation.com/docs/next/guides/variables) like [`<Var>`](https://generaltranslation.com/docs/next/api/components/var) and [`<Num>`](https://generaltranslation.com/docs/next/api/components/num).
