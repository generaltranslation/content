...
Our [`<Plural>`](/docs/react/reference/components/plural) component falls back to its children if the number provided to `n` doesn't match any of the provided props.
