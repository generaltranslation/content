...
**1. Install and write code.** Run the [setup wizard](/docs/cli/quickstart) and wrap content in [`<T>`](/docs/react/reference/components/t) components. No key extraction. No JSON files.
