...
2. **A translation management system (TMS)** — stores translation files, manages workflows, and coordinates handoffs. It sits between your code and your translators but doesn't do the translating.
