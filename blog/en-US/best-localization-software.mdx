...
2. **A translation management system (TMS)** — stores translation files, manages workflows, and coordinates handoffs. Organizing, not producing.
...
Popular i18n libraries for React and Next.js handle rendering well: interpolation, pluralization, locale routing, Server Component support.

**But they don't translate anything.**

They render translations. They don't produce them. You still need to:
