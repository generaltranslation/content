...
There are six things you need to get right, and this guide covers all of them using [gt-next](https://generaltranslation.com/docs/next).
...
- [gt-next quickstart](https://generaltranslation.com/docs/next) to set up the full i18n stack
